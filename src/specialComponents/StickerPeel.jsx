...
StickerPeel.propTypes = {
  imageSrc: PropTypes.string.isRequired,
  rotate: PropTypes.number,
  peelBackHoverPct: PropTypes.number,
  peelBackActivePct: PropTypes.number,
  peelEasing: PropTypes.string,
  peelHoverEasing: PropTypes.string,
  width: PropTypes.oneOfType([PropTypes.number, PropTypes.string]),
  shadowIntensity: PropTypes.number,
  lightingIntensity: PropTypes.number,
  initialPosition: PropTypes.oneOfType([
    PropTypes.oneOf(['center']),
    PropTypes.shape({ x: PropTypes.number, y: PropTypes.number })
  ]),
  peelDirection: PropTypes.number,
